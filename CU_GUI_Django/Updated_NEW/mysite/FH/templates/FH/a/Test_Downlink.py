...
"")
        ...
        self.run_pushButton_2 = QtWidgets.QPushButton(self.frame_3,clicked= lambda: self.Loading())
        ...
        self.UL_pushButton_5 = QtWidgets.QPushButton(self.frame_3)
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.UL_pushButton_5.setFont(font)
        self.UL_pushButton_5.setObjectName("UL_pushButton_5")
        self.horizontalLayout_2.addWidget(self.UL_pushButton_5)
        ...
        self.Both_pushButton_6 = QtWidgets.QPushButton(self.frame_3)
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.Both_pushButton_6.setFont(font)
        self.Both_pushButton_6.setObjectName("Both_pushButton_6")
        self.horizontalLayout_2.addWidget(self.Both_pushButton_6)
    ...
    def retranslateUi(self, set_value__MainWindow):
        ...
        self.run_pushButton_2.setText(_translate("set_value__MainWindow", "RUN DL"))
        self.UL_pushButton_5.setText(_translate("set_value__MainWindow", "RUN UL"))
        self.Both_pushButton_6.setText(_translate("set_value__MainWindow", "RUN BOTH"))
    ...
    def start_process(self):
        ...
        if self.p is None:  # No process running.
            ...
            self.p.start("/home/vvdn/Documents/Mavenir_8/Mavenir_8/bin/python", ['/home/vvdn/Documents/Mavenir_8/Mavenir_8/Mavu_ru/Downlink/8t8r_dl.py'])      
            return True    
    ...
    def Loading(self):
        ...
        self.timer.singleShot(1000,self.start_process)
