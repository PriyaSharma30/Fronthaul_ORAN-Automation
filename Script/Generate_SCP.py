...
def Base_DL_TDD(bands, phase_comp, sub_folder, DL_Center_Freq, Power_Value, VXT_Add):
    api = Api()
    api.New()
    status = Instrument_Setup(DL_Center_Freq, Power_Value, VXT_Add, api)
    print("-Setting DL carrier 5G NR Testmodel required Configurations")
...
def Extended_DL_TDD(bands, phase_comp, sub_folder, DL_Center_Freq, Power_Value, VXT_Add):
    api = Api()
    api.New()
    status = Instrument_Setup(DL_Center_Freq, Power_Value, VXT_Add, api)
    print("-Setting DL carrier 5G NR Testmodel required Configurations")
...
def Compression_TDD_DL(bands, phase_comp, sub_folder, DL_Center_Freq, Power_Value, VXT_Add):
    api = Api()
    api.New()
    status = Instrument_Setup(DL_Center_Freq, Power_Value, VXT_Add, api)
    print("-Setting DL carrier 5G NR Testmodel required Configurations")
